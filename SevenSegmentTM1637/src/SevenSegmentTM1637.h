...
#define TM1637_DEFAULT_BLINK_DELAY    500      // 
...
public:
  ...
  */
  void    blink(int blinkDelay = TM1637_DEFAULT_BLINK_DELAY, uint8_t repeats = TM1637_DEFAULT_BLINK_REPEAT, uint8_t maxBacklight=100, uint8_t minBacklight=0);
